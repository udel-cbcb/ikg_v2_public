...
class SimpleEmbedder(PyTorchTrial):
    ...
    def _load_data(self):
        ...
        train_triples_indexed_pd_phosp = train_triples_indexed_pd[train_triples_indexed_pd["relation"] == p_id]
        train_triples_indexed_pd_non_phosp = train_triples_indexed_pd[train_triples_indexed_pd["relation"] != p_id].sample(frac=0.25,random_state=20)
        train_triples_indexed_pd = pd.concat([train_triples_indexed_pd_phosp,train_triples_indexed_pd_non_phosp],ignore_index=True)"""
