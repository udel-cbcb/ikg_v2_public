...
class ProteinCallBack(PyTorchCallback):

    def __init__(self,trial,node_labels,early_stopping_delta,early_stopping_patience,fold_n):
        self.trial = trial
    ...
    def save_embedding(self,checkpoint_dir):
        ...
        embeddings_df.insert(0,"protein",self.node_labels)
