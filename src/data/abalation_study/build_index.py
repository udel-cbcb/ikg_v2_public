...
def build_index():
    ...
    for fold_n in tqdm(range(folds),total=folds):
        ...
        for data_set in sets:
            ...
            train_triples_pd = pd.read_csv(f"{data_dir}/processed/annotated/{data_set}/folds/fold_{fold_n}/train_triples.csv")
            ...
            entity_map = {}
            logger.info(f"Creating entity mapping: {data_set}")
            ...
            logger.info(f"Creating relation mapping: {data_set}")
            ...
            out_path = f"{data_dir}/processed/annotated/{data_set}/folds/fold_{fold_n}"
