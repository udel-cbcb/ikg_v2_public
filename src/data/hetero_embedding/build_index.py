...
def build_index():
    ...
    for fold_n in tqdm(range(folds),total=folds):
        ...
        train_triples_pd = pd.read_csv(f"{data_dir}/processed/annotated/folds/fold_{fold_n}/train_triples.csv")
        ...
        entity_map = {}
        logger.info("Creating entity mapping")
        ...
        logger.info("Creating relation mapping")
        ...
        out_path = f"{data_dir}/processed/annotated/folds/fold_{fold_n}"
